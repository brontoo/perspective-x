...
export default function RoleHub() {
    ...
    // Fetch scenario settings only (lightweight)
    ...
    const isUnlocked = (scenarioId) => {
        // Teacher has full control — is_locked always takes precedence
    ...
    const getScenarioStatus = (scenarioId) => {
        // is_locked always takes precedence
        ...
        <div className="min-h-screen lx-bg-ambient">
            ...
            <section className="px-6 py-6">
                <div className="max-w-6xl mx-auto text-center">
                    <p className="text-sm text-[var(--lx-text-muted)] font-medium">
                        Complete missions in order to unlock new challenges. Navigate through the available content and earn your certification.
                    </p>
                </div>
            </section>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <span className="text-[10px] font-mono text-[var(--lx-accent)] tracking-widest uppercase px-3">
                            Available Missions :: {role.scenarios.length} Missions
                        </span>
