...
import { GraduationCap, BookOpen } from 'lucide-react'; // ← Removed Mail because we won't use it
...
export default function SignIn() {
    ...
    // ← Removed showEmailConfirm completely
    ...
    const handleSubmit = async (e) => {
        ...
        if (mode === 'signup') {
            ...
            // ← Direct redirect based on role after registration, without confirmation screen
            if (role === 'teacher') {
        ...
        if (signInError) {
            // ← Unified error message without mentioning email confirmation
    ...
    // ── UI ──
    return (
        <div className="min-h-screen lx-bg-ambient flex items-center justify-center px-4">
            <motion.div
