                        ...
                        <div className="lg:col-span-5 space-y-6">
                            <div className="grid grid-cols-1 gap-4">
                                {[
                                    ...
                                    <div key={i} className="flex items-center justify-between p-5 rounded-2xl bg-slate-900/60 border border-white/5 group hover:border-teal-500/20 transition-colors">
                            ...
                            <div className={`p-6 rounded-3xl border ${theme.border} bg-slate-900/40`}>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {scenario.scienceFocus?.map((focus, i) => (
                                        <span key={i} className={`px-3 py-1.5 rounded-xl text-[10px] font-bold border border-white/5 bg-slate-800/80 text-slate-300 hover:border-teal-500/30 transition-colors`}>
                                            {focus}
                                        </span>
                                    ))}
                                </div>
