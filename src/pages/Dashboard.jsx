...
export default function Dashboard() {
    ...
    const loadProgress = async () => {
        try {
            ...
            if (progressRows && progressRows.length > 0) {
                // ✅ Only unique completed scenarios
                ...
                // ✅ We take the last row for each unique scenario only
                const allDecisions = completedScenarios.flatMap(scenarioId => {
                    ...
                    // Extract decisions from scene1, scene2, scene3
                ...
                // Actual time from database or calculated based on completed
                // ✅ We use completedScenarios which is already unique
    ...
    const stats = [
        ...
        { label: 'Choices Made', value: progress?.decision_history?.length || 0, Icon: Target, from: 'from-purple-500/10', to: 'to-pink-500/10', border: 'border-purple-500/30', bg: 'bg-purple-500/20', text: 'text-purple-400' },
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-6">
                        ...
                        <div className="flex gap-4">
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-[var(--lx-text-muted)] text-xs">Choices</p>
                            </div>
                        </div>
                    </div>
                </motion.div>
