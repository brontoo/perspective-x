                    ...
                    <div className="border border-slate-700 rounded-xl p-4 bg-slate-800/50">
                        ...
                        <div className="text-slate-300 text-sm space-y-2">
                            {(answers.scene1.selectedOption || answers.scene1.decision_id) && (
                                <div>
                                    <p className="text-slate-400 text-xs">Choice Made:</p>
                            ...
                            {(answers.scene1.justification || answers.scene1.reasoning) && (
                                <div>
                                    ...
                                    <p className="text-white whitespace-pre-wrap">{answers.scene1.justification || answers.scene1.reasoning}</p>
                                </div>
                            )}
                    ...
                    <div className="border border-slate-700 rounded-xl p-4 bg-slate-800/50">
                        ...
                        <div className="text-slate-300 text-sm space-y-2">
                            ...
                            {(answers.scene3.justification || answers.scene3.reasoning) && (
                                <div>
                                    <p className="text-slate-400 text-xs">Reasoning:</p>
                                    <p className="text-white whitespace-pre-wrap">{answers.scene3.justification || answers.scene3.reasoning}</p>
                                </div>
                            )}
                        ...
                        <div className="text-slate-300 text-sm space-y-3">
                            ...
                            {answers.exitTicket.score !== undefined && (
                                <div className="flex items-center justify-between pt-2 border-t border-slate-700">
                                    ...
                                    <span className={`text-sm font-bold ${answers.exitTicket.score >= 80 ? 'text-emerald-400' : 'text-amber-400'}`}>
                        ...
                        <div className="flex-1 overflow-y-auto p-5 sm:p-6">
                            {normalizedAttempts.length === 0 ? (
                                <div className="text-center py-12 text-slate-500">
                                    ...
                                    <p>No scenario attempts found</p>
                                </div>
                            ) : (
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <div className="flex items-center gap-3 ml-4 flex-shrink-0">
                                                    <span className={`text-sm font-bold px-3 py-1 rounded-lg ${attempt.score >= 80
